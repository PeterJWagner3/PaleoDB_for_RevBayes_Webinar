...
polymorphs <- T;								# are there polymorphic characters in your matrix?
...
scribere_RevBayes_scripts_from_nexus_file_and_existing_FBD_script_and_data(analysis_name,fbd_parameterization_script,fossil_interval_file,taxon_subset_file,rate_partition,trend_partition,write_data_directory,write_scripts_directory,local_directory,set_wdir,polymorphs);
...
scribere_RevBayes_scripts_from_nexus_file_and_existing_FBD_script_and_data(analysis_name,fbd_parameterization_script,fossil_interval_file,taxon_subset_file,rate_partition,trend_partition,write_data_directory,write_scripts_directory,local_directory,set_wdir);
