...
plant_phyla <- c("Aneurophytophyta","Angiospermae","Antherocerotophyta","Anthophyta","Archaeopteridophyta","Botryopteridiophyta","Bryophyta","Chlorophyta","Cladoxylophyta","Coniferophyta","Cycadeoideophyta","Cycadophyta","Equisetophyta","Filicophyta","Ginkgophyta","Gnetophyta","Gymnospermae","Gymnospermophyta","Isoetophyta","Langiophytophyta","Lycophyta","Lycopodiophyta","Lycopodophyta","Magnoliophyta","Marattiophyta","Marchantiophyta","Moresnetiophyta","Noeggerathiophyta","Ophioglossophyta","Peltaspermophyta","Pinophyta","Polypodiophyta","Progymnospermophyta","Psilophytophyta","Pteridophyta","Pteridospermophyta","Rhodophyta","Rhyniophyta","Spermatophyta","Sphenophyllophyta","Sphenophyta","Thallophyta","Tracheophyta","Trimerophytophyta","Zosterophyllophyta");
protist_phyla <- c("Actinopoda","Bacillariophyta","Foraminifera","Heterokontophyta","Ochrophyta","Prasinophyta","Radiolaria","Sarcodina");
