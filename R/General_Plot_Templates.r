...
#### Stylized Axes ####
log_axes <- function(axe,min_ax,max_ax,increment,numbers,linewd=4/3,orient,font="")	{
...
for (i in 1:ticks)	{
  ...
  if (font=="")	{
    ...
    axis(2,at=log(l),tcl=-.3,labels=numbers[i],lwd=0,lwd.ticks=linewd,las=orient,family=font);
...
log10_axes <- function(axe,min_ax,max_ax,numbers,linewd=4/3,font_size=1,orient=1,font="")	{
...
log2_axes <- function(axe,min_ax,max_ax,numbers,linewd=4/3,orient,font="")	{
...
#    axis(2,at=log(l),tcl=-.3,labels=numbers[i],lwd=0,lwd.ticks=linewd,las=orient);
    ...
    axis(axe,at=log2(l),tcl=-.3,labels=numbers[i],lwd=0,lwd.ticks=linewd,las=orient,family=font);
#    axis(2,at=log(l),tcl=-.3,labels=numbers[i],lwd=0,lwd.ticks=linewd,las=orient,family=font);
#  	axis(axe,at=log10(l),tcl=-.3,labels=numbers[i],lwd=0,lwd.ticks=0,las=orient,cex.axis=font_size,family=font);
  	}
#	i <- i+1
...
#    mtext(ordinate2,side=4,line=2,family=font);
  ...
  par(xpd = F); #Draw outside plot area
  }
if (med_break!=0)	{
